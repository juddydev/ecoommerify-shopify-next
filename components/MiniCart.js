                    ...
                    <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                ...
                                <ul role="list" className="-my-6 divide-y divide-gray-200">
                                    ...
                                    <li key={product.id + Math.random()} className="flex py-6">
                                        ...
                                        <div>
                                            ...
                                            <h3>
                                                <Link 
                                                    href={`/products/${product.handle}`} passHref>
                                                    <a onClick={() => setCartOpen(!cartOpen)}>{product.title}</a>
                                                </Link>
                                            </h3>
...

                        {
                            ...
                            <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                                ...
                                <a
                                    href={checkoutUrl}
                                    className="flex items-center justify-center rounded-md border border-transparent bg-gray-900 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-gray-800 transition-colors duration-300"
                                >
                                    Checkout
                                </a>
                                </div>
